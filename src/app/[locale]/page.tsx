...
export default function Home() {
  ...
  return (
    <>
      {/* SEO-optimized H1 tag - hidden visually but available for screen readers and search engines */}
      ...
      <section className="relative flex flex-col items-center justify-items-center w-full min-h-screen overflow-hidden">
        ...
        <section className="w-full max-w-[1200px] mx-auto relative z-10 overflow-x-visible">
          <Purpose />
        </section>
      </section>
    </>
