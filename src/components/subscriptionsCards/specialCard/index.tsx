  ...
  return (
    ...
    >
      <section className="w-full flex flex-nowrap items-center justify-between">
        ...
        <ToggleSwitch label={t("home.subscriptions.plans.nomad.yearly")} isChecked={isYearly} onToggle={onToggle} />
      </section>
      ...
      <section className="flex flex-row flex-nowrap items-end justify-start">
        ...
        {isYearly && <p className="text-xs font-bold mb-1">{t("home.subscriptions.plans.nomad.billendAnnually")}</p>}
      </section>
